...
$pdf->writeHTMLCell('', '', 50, 65, '<span style="font-size:20px;">name</span>', 0, 0, false, true, 'J', true);

$pdf->writeHTMLCell('', '', 15, 80, '<span style="font-weight:bold; font-size:20px;">สังกัด</span>', 0, 0, false, true, 'J', true);
$pdf->writeHTMLCell('', '', 50, 80, '<span style="font-size:20px;">unit_name</span>', 0, 0, false, true, 'J', true);
...
$pdf->writeHTMLCell('', '', 50, 110, '<span style="color: red; font-size:20px;">time_test น.</span>', 0, 0, false, true, 'J', true);

$pdf->writeHTMLCell('', '', 15, 125, '<span style="font-weight:bold; font-size:20px;">สถานที่สอบ</span>', 0, 0, false, true, 'J', true);
$pdf->writeHTMLCell('', '', 50, 125, '<span style="color: red; font-size:20px;">room_name</span>', 0, 0, false, true, 'J', true);
...
$pdf->writeHTMLCell(45, 45, 155, 75, '<span style="font-weight:bold; font-size:56px;">48</span>', 0, 0, false, true, 'C', true);
...
$pdf->write1DBarcode('1969900135601', 'C39', 10, 145, '', 25, 0.4, $style, 'N'); // CREATE BARCODE
...
$pdf->write2DBarcode('www.tcpdf.org', 'QRCODE,L', 150, 125, 50, 50, $style, 'N');
...
$filename = "idp.pdf";
$result = $pdf->Output(FCPATH . "/assets/PDF_generate/$filename", 'I');
